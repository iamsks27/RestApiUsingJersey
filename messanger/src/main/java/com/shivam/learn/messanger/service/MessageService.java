package com.shivam.learn.messanger.service;
...
import com.shivam.learn.messanger.database.DatabaseClass;
import com.shivam.learn.messanger.exception.DataNotFoundException;
import com.shivam.learn.messanger.models.Message;
...
public class MessageService {
	...
	public List<Message> getAllMessagesPaginated(int start, int size) {
		List<Message> messagesPagination = new ArrayList<>(messages.values());
